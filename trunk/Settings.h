...
class cSettings : private QObject
{
	public:
		...
		bool GetShowDirectoryViewHeader();							///< get directory view header show flag
		...
		void SetShowDirectoryViewHeader(const bool &bShow);	///< set directory view header show flag
